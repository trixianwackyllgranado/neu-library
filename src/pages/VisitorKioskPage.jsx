    ...
    >
      ...
      <div style={{ marginTop: 14, padding: '10px 14px', borderRadius: 10, background: 'var(--surface)', border: '1px solid var(--card-border)' }}>
        <p style={{ fontFamily: "'Poppins',sans-serif", fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.6 }}>
          Your session has started. You can <strong style={{ color: 'var(--text-primary)' }}>leave this screen on</strong>, close the app, or even sign out — your library visit stays active.<strong style={{ color: 'var(--green)' }}>ONLY log out when you leave</strong> the library.
        </p>
      </div>
