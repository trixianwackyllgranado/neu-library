  ...
  return (
    <div style={{ animation:'fadeUp 0.3s ease both' }}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:12}}>
        {/* --- NEW: VISITOR STATISTICS LINK --- */}
        <QuickLink label="Visitor Statistics" sub="View library check-in analytics" path="/admin/visitor-stats" accentColor="#8b5cf6" navigate={navigate} />
